...
rag_cohere = Cohere()
rag_cohere_results = rag_cohere.answer(request=request)
rag_gpt4 = GPT("gpt-4")
rag_gpt4_results = rag_gpt4.answer(request=request)

print("Cohere Results:")
for result in rag_cohere_results:
    print(result)

print("\nGPT-4 Results:")
for result in rag_gpt4_results:
    print(result)
